...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
   ...
   <script type="text/javascript">
    ...
    function qnawrite(x){
    	...
    	if(x=='insert'){
    		writeform.action="qnawrite_view.do";
    	}else if(x=='list'){
    		writeform.action="qnalist.do";
    	}else if(x=='update'){
    		writeform.method="get";
    		writeform.action="qna_update_view.do";
    	}else if(x=='delete'){
    		writeform.method="get";
    		writeform.action="qna_delete.do";
    	}else if(x=='comment'){
    		if(${userId==null}){
        		alert("로그인이 필요합니다");
        		writeform.action="login.do";
    		}else{
    			writeform.method="get";
    			writeform.action="reply_view.do";
        		}
    	}
    	writeform.submit();
    }
...
<body>
        ...
        <form name="wirteform">
        	...
        	<input type="hidden" name="bid" value="${qnadetail.bid }">
        	<input type="hidden" name="page" value="${QnAPageDto.currentPageNum }">
        	<input type="hidden" name="pageDataCount" value="${QnAPageDto.pageDataCount }">
        <div id="QnA_write">
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" name="userid" value="${qnadetail.id }" readonly></td>
                    </tr>
                    <tr>
                        <th>제 목</th>
                      </tr>
                    <tr>
                          ...
                          <td><input type="text" name="btitle" value="${qnadetail.btitle }" readonly></td>
                    </tr>
                    <tr>
                        <th>내 용</th>
                      </tr>
                    <tr>
                          <td><textarea name="bcontent" readonly>${qnadetail.bcontent }</textarea></td>
                    </tr>
                </table>
                
            </div>
            <div id="writeBtn">
            <c:if test="${userId==qnadetail.id }">
            	<input type="button"  value="수정" onclick="qnawrite('update')">
            	<input type="button"  value="삭제" onclick="qnawrite('delete')">
            </c:if>
            	<input type="button"  value="댓글" onclick="qnawrite('comment')">
