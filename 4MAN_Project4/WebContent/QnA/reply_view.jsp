...
<body>
		...
		<input type="hidden" name=bgroup value="${qnadetail.bgroup}"/>
		<input type="hidden" name=bstep value="${qnadetail.bstep }"/>
		<input type="hidden" name=bindent value="${qnadetail.bindent }"/>
		<input type="hidden" name=page value="${QnAPageDto.currentPageNum }"/>
		<input type="hidden" name=pageDataCount value="${bPageDto.pageDataCount }"/>
                <h2>댓글 달기</h2>
                <table>
                    <tr>
                      <th>아이디</th>
