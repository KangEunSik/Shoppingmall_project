...
<body>
        ...
        <div id="blink">
             ...
             <c:forEach items="${findPw }" var="findPw">
                 <form action="find_pwView.do" method="get">
                    <div>
                   
                        <table id="form">
                        <h2 id="h2"><b>PASSWORD 찾기</b></h2>
            <tr>
                <td class="col1">비밀번호</td>
                <td class="col2">${findPw.pw }</td>
            </tr>
            </table>
            </div>
            ...
            <div class="create">
                ...
                <input class="but3" type="button" value="ID 찾기" onclick="location.href='find_id.do'">
                <input class="but4" type="button" value="찾기" onclick="">
