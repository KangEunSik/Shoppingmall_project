...
<body>
        ...
        <div id="product">
            ...
            <div class="item">
                <ul>
                    <li><a href="detail_product.do?Pnum=${best.PNum }"><img src="images/${best.pimage }/${best.pimage }-0.JPG"></a></li>
                    <li class="subject">${best.pname }</li>
                    <li class="comment">${best.PContent }</li>
                    <li class="price">${best.pprice }원</li>                
                </ul>
            </div>
            </c:forEach>
   	   </div>
