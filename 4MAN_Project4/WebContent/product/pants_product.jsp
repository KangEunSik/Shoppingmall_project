...
<body>
        ...
        <div id="product">
            ...
            <div class="item">
                <ul>
                    <li><a href="detail_product.do?Pnum=${Pants.PNum }"><img src="images/${Pants.pimage }/${Pants.pimage }-0.JPG"></a></li>
                    <li class="subject">${Pants.pname }</li>
                    <li class="comment">${Pants.PContent }</li>
                    <li class="price">${Pants.pprice }원</li>                
                </ul>
            </div>
            </c:forEach>
   	   </div>
