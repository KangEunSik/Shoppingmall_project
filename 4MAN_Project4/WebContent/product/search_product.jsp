 <%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.fourman.dao.ProductDao" %>
        ...
        <div id="header">
            ...
            <div class="nav">
                ...
                <form action="">
                    <div class="search">
                        <div>
                          <input type="text" placeholder="Search " required onclick="search()">
                        </div>
                      </div>
                </form>
                </div>
        ...
        <div id="product">
         <c:forEach items="${search}" var="search">
            <div class="best_title">
                 <h4>'${search.pname }'에 대한 검색 결과 </h4>
            </div>
           
            <div class="item">
                <ul>
                    <li><a href="detail_product.do?Pnum=${search.PNum }"><img src="images/${search.pimage }/${search.pimage }-0.JPG"></a></li>
                    <li class="subject">${search.pname }</li>
                    <li class="comment">${search.PContent }</li>
                    <li class="price">${search.pprice }원</li>                
                </ul>
            </div>
            </c:forEach>
   	   </div>
