...
<body>
        ...
        <div id="product">
            ...
            <div class="item">
                <ul>
                    <li><a href="detail_product.do?Pnum=${Shoes.PNum }"><img src="images/${Shoes.pimage }/${Shoes.pimage }-0.JPG"></a></li>
                    <li class="subject">${Shoes.pname }</li>
                    <li class="comment">${Shoes.PContent }</li>
                    <li class="price">${Shoes.pprice }원</li>                
                </ul>
            </div>
            </c:forEach>
   	   </div>
