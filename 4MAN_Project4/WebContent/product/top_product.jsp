...
<body>
        ...
        <div id="product">
            ...
            <div class="item">
                <ul>
                    <li><a href="detail_product.do?Pnum=${Top.PNum }"><img src="images/${Top.pimage }/${Top.pimage }-0.JPG"></a></li>
                    <li class="subject">${Top.pname }</li>
                    <li class="comment">${Top.PContent }</li>
                    <li class="price">${Top.pprice }원</li>                
                </ul>
            </div>
            </c:forEach>
   	   </div>
